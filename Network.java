...
public class Network {
    ...
    *  Otherwise, creates a new user with the given name, adds the user to this network, and returns true. */
    ...
    public String recommendWhoToFollow(String name) {
        ...
        for (int i = 0; i < userCount; i++) {
            ...
            if (mutualCount > maxMutual) {
                ...
                mostRecommendedUserToFollow = currentUser;
            }
        }
    ...
    public String mostPopularUser() {
        ...
        int maxFolloweeCount = followeeCount(mostPopular);
        
        for (int i = 1; i < userCount; i++) {
            String currentName = users[i].getName();
            int currentFolloweeCount = followeeCount(currentName);
            if (currentFolloweeCount > maxFolloweeCount) {
